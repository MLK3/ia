function [Q,Qabs,W,Wreal,WrealAbs,piAbs,nPassos,Wgain,PiUse,nReuse] = SARSA2L(environment,locations,DTG,goal,mi,gamma,lambda,initialEpsilon,vu2,tau,deltaTau,initialStates,fatorEval,maxSteps,ACTION,ABSACTIONS)
